...
function preload()
{
    dn = ml5.imageClassifier('Doodlenet');
}
function cc()
{
    dn.classify(canvas,gotResults)
}
function gotResults(error,results)
{
    ...
    {
        console.log(results);
        document.getElementById('ys').innerHTML = 'Sketch : '+results[0].label;
        per = floor(results[0].confidence*100);
        document.getElementById('yc').innerHTML = 'Confidence : '+per;
    }
}
